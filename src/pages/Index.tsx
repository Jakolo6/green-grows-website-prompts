...
const Index = () => {
  ...
  const values = [
    ...
    {
      icon: <FlaskConical className="w-12 h-12 text-emerald-600" />,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
      ...
      <header className="bg-white/80 backdrop-blur-sm border-b border-emerald-100 sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-2xl font-bold text-emerald-800">VitalGreen</h1>
          </div>
          <nav className="hidden md:flex space-x-8">
            <a href="#philosophy" className="text-emerald-700 hover:text-emerald-900 transition-colors">Philosophie</a>
            <a href="#plans" className="text-emerald-700 hover:text-emerald-900 transition-colors">Pläne</a>
            <a href="#testimonials" className="text-emerald-700 hover:text-emerald-900 transition-colors">Kundenstimmen</a>
            <a href="#contact" className="text-emerald-700 hover:text-emerald-900 transition-colors">Kontakt</a>
          </nav>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
          <div className="animate-fade-in">
            <h2 className="text-5xl md:text-7xl font-bold text-emerald-800 mb-6 leading-tight">
              Nähre deinen Körper.
              <br />
              <span className="text-emerald-600">Nähre den Planeten.</span>
            </h2>
        ...
        <div className="absolute top-20 left-10 animate-bounce delay-300">
          <div className="w-16 h-16 bg-emerald-200 rounded-full opacity-60"></div>
        </div>
      ...
      {/* Philosophy Section */}
      <section id="philosophy" className="py-20 bg-gradient-to-br from-emerald-50 to-green-100 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <svg viewBox="0 0 100 100" className="w-full h-full">
            <path d="M20,50 Q50,20 80,50 Q50,80 20,50" fill="currentColor" className="text-emerald-300"/>
          </svg>
        </div>
        
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <h3 className="text-4xl md:text-5xl font-bold text-emerald-800 mb-6">Unsere Philosophie</h3>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {values.map((value, index) => (
              <Card key={index} className="bg-white/70 backdrop-blur-sm border-emerald-200 hover:shadow-lg transition-all duration-300 hover:scale-105">
                <CardHeader className="text-center">
                  <div className="mx-auto mb-4 p-4 bg-emerald-100 rounded-full w-fit">
                    {value.icon}
                  </div>
                  <CardTitle className="text-2xl text-emerald-800">{value.title}</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-emerald-700 text-center">{value.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>
      ...
      <section id="plans" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h3 className="text-4xl md:text-5xl font-bold text-emerald-800 mb-6">Unsere Pläne</h3>
            <p className="text-xl text-emerald-700 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {plans.map((plan, index) => (
              <Card key={index} className={`relative hover:shadow-xl transition-all duration-300 ${plan.popular ? 'border-emerald-500 border-2 scale-105' : 'border-emerald-200'}`}>
                {plan.popular && (
                ...
                <CardHeader className="text-center">
                  ...
                  <CardTitle className="text-2xl text-emerald-800">{plan.title}</CardTitle>
                  <CardDescription className="text-emerald-600">{plan.description}</CardDescription>
                  <div className="text-3xl font-bold text-emerald-800 mt-4">{plan.price}</div>
                </CardHeader>
                <CardContent>
      ...
      <section id="testimonials" className="py-20 bg-gradient-to-br from-green-50 to-emerald-100">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h3 className="text-4xl md:text-5xl font-bold text-emerald-800 mb-6">Was unsere Kunden sagen</h3>
          ...
          <div className="max-w-4xl mx-auto">
            <Carousel className="w-full">
                  ...
                  <CarouselItem key={index}>
                    <Card className="bg-white/80 backdrop-blur-sm border-emerald-200">
                      <CardContent className="p-8 text-center">
                        ...
                        <blockquote className="text-lg text-emerald-700 mb-6 italic">
                          "{testimonial.text}"
                        </blockquote>
                        ...
                        <cite className="text-emerald-800 font-semibold">
                          {testimonial.name}
                        </cite>
                      </CardContent>
                    </Card>
              ...
              <CarouselPrevious className="border-emerald-200 text-emerald-600" />
              <CarouselNext className="border-emerald-200 text-emerald-600" />
            </Carousel>
          </div>
        </div>
      </section>
      ...
      <footer id="contact" className="bg-emerald-900 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              <h5 className="font-semibold mb-4 text-emerald-300">Links</h5>
            ...
            <div>
              <h5 className="font-semibold mb-4 text-emerald-300">Legal</h5>
              <ul className="space-y-2 text-emerald-200">
            ...
            <div>
              <h5 className="font-semibold mb-4 text-emerald-300">Folgen Sie uns</h5>
